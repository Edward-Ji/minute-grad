...
from layer import Composite, CrossEntropyLoss, ReLU, Linear, LeakyReLU, Sigmoid
from optimiser import AdamOptimiser
from tensor import Tensor
from util import kaiming_uniform, xavier_uniform
...
def main():
    ...
    folder = "./experiments/results/activation_test"
